...
import 'package:eassist_tools_app/widgets/combobox/combomconveyby_widget.dart';
...
class SimulcargoCrudFormPage extends StatefulWidget {
  ...
  const SimulcargoCrudFormPage(
      {super.key, required this.viewMode, required this.recordId});

  @override
  SimulcargoCrudFormPageFormState createState() =>
      SimulcargoCrudFormPageFormState();
}
