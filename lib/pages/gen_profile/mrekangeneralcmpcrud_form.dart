...
class MRekanGeneralCmpCrudFormPage extends StatefulWidget {
	...
	@override
	MRekanGeneralCmpCrudFormPageFormState createState() => MRekanGeneralCmpCrudFormPageFormState();
}

class MRekanGeneralCmpCrudFormPageFormState extends State<MRekanGeneralCmpCrudFormPage> {
	...
	void onSaveForm() {
      ...
      record.mrekan1Id = mRekanGeneralCmpCrudBloc.state.record!.mrekan1Id;
      mRekanGeneralCmpCrudBloc.add(MRekanGeneralCmpCrudUbahEvent(record: record));
