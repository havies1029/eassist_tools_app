...
import 'package:eassist_tools_app/blocs/gen_profile/rekangeneral_bloc.dart';
import 'package:eassist_tools_app/models/gen_profile/rekangeneral_model.dart';
							...
							child: Form(
								...
								child: Column(
									children: [
										...
										Text(
											"${widget.viewMode == "tambah" ? "Tambah" : "Ubah"} Informasi Umum",
		...
		return buildFieldComboMJnskel(
			...
			onChangedCallback: (value) {
				if (value != null) {
					...
					rekanGeneralBloc.add(ComboMJnskelChangedEvent(comboMJnskel: value));
				}
			},
			onSaveCallback: (value) {
				if (value != null) {
