...
class _HeroUserPageState extends State<HeroUserPage> {
                ...
                child: Stack(
                  children: [
                    Positioned(
                      top: 80,
                      right: 16,
                      child: _buildHamburgerDropdownMenu(),
                    ),
                  ],
                ),
              ),
                ...
                child: Stack(
                  children: [
                    Positioned(
                      top: 80,
                      right: 72,
                      child: _buildProfileDropdownMenu(),
                    ),
                  ],
                ),
              ),
              ...
              child: IconButton(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    if (_isMenuOpen) {
                      _isProfileMenuOpen = false; // Tutup profile menu jika hamburger dibuka
                    }
                  });
                },
      ...
      child: InkWell(
        onTap: () {
          setState(() {
            ...
            if (_isProfileMenuOpen) {
              _isMenuOpen = false; // Tutup hamburger menu jika profile dibuka
            }
          });
        },
        borderRadius: BorderRadius.circular(8),
  ...
  Widget _buildProfileDropdownMenu() {
    return Material(
      elevation: 8,
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => setState(() => _isProfileMenuOpen = false),
  ...
  Widget _buildHamburgerDropdownMenu() {
    return Material(
      elevation: 8,
      borderRadius: BorderRadius.circular(12),
      child: Container(
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  DropdownExpandableItem(
                    icon: Icons.info, // Ganti ikon utama agar lebih sesuai dengan "Tentang JPS"
                    title: 'Tentang JPS',
                    subItems: [
                      SubMenuItem(
                        icon: Icons.info_outline, // Lebih cocok untuk 'Tentang JPS'
                        title: 'Tentang JPS',
                        onTap: () => _handleMenuTap('Tentang JPS'),
                      ),
                      SubMenuItem(
                        icon: Icons.article_outlined, // Cocok untuk artikel atau panduan
                        title: 'Artikel Asuransi',
                        onTap: () => _handleMenuTap('Artikel Asuransi'),
                      ),
                      SubMenuItem(
                        icon: Icons.reviews, // Cocok untuk testimoni
                        title: 'Testimoni',
