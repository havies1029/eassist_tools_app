...
import 'package:eassist_tools_app/blocs/gen_klaim/klaim1list_bloc.dart';
import 'package:eassist_tools_app/blocs/gen_klaim/klaim1crud_bloc.dart';
import 'package:eassist_tools_app/pages/gen_klaim/klaim1list_tile_widget.dart';
														...
														Navigator.push(
															...
															MaterialPageRoute(
																builder: (_) => Klaim2ListMainPage(
																	// klaim1Id: state.items[index].klaim1Id, // kirim klaim1Id
																),
															),
														);
													},
