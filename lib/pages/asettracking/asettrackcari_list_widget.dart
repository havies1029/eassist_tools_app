        ...
        ? Flexible(
          child: ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              final isSelected = (state.selectedAsettrackCari?.prosesId == item.prosesId && 
                                  state.selectedAsettrackCari?.prosesSource == item.prosesSource);
              return InkWell(
                borderRadius: BorderRadius.circular(15),
                onTap: () {
                  context
                      .read<AsettrackCariBloc>()
                      .add(SelectAsettrackCariEvent(selectedAsettrackCari: item));
                    },
                child: Container(
