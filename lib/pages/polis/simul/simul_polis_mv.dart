...
class SimulPolisMvMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SimulPolisMvPage(),
    );
  }
}

class SimulPolisMvPage extends StatefulWidget {
  const SimulPolisMvPage({super.key});

  @override
  State<SimulPolisMvPage> createState() => _SimulPolisMvPageState();
}

class _SimulPolisMvPageState extends State<SimulPolisMvPage> {
