...
class UserJpsMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserJpsPage(),
    );
  }
}

class UserJpsPage extends StatefulWidget {
  const UserJpsPage({super.key});

  @override
  State<UserJpsPage> createState() => _UserJpsPageState();
}

class _UserJpsPageState extends State<UserJpsPage> {
