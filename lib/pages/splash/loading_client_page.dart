...
class LoadingClientPage extends StatefulWidget {
  ...
  @override
  State<LoadingClientPage> createState() => _LoadingClientPageState();
}

class _LoadingClientPageState extends State<LoadingClientPage> with SingleTickerProviderStateMixin {
