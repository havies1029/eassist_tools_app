...
class SimultreeCrudFormPageFormState extends State<SimultreeCrudFormPage> {
	...
	var fieldSi1Controller = TextEditingController();
	var fieldSi2Controller = TextEditingController();
				...
				listener: (context, state) {
					if (state.isLoaded) {
						if (state.record != null){
							...
							fieldSi1Controller.text = NumberFormat("#,###").format(state.record!.si1);
							fieldSi2Controller.text = NumberFormat("#,###").format(state.record!.si2);
	...
	void onSaveForm() {
		if (_formKey.currentState!.validate()) {
			...
			SimultreeCrudModel record = SimultreeCrudModel(
				...
				si1: double.parse(fieldSi1Controller.text.replaceAll(',', '')),
				si2: double.parse(fieldSi2Controller.text.replaceAll(',', '')),
				simultreeId: '',
