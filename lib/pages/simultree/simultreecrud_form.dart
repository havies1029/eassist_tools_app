...
class SimultreeCrudFormPage extends StatefulWidget {
	...
	const SimultreeCrudFormPage(
			{super.key, required this.viewMode, required this.recordId});

	@override
	SimultreeCrudFormPageFormState createState() =>
			SimultreeCrudFormPageFormState();
}
											...
											children: [
												SizedBox(
													...
													child: Padding(
														...
														child: ElevatedButton(
															onPressed: () {
																simultreeCrudBloc
																		.add(SimultreeCrudInitValueEvent());
															},
															child: const Text(
																'Reset',
												...
												SizedBox(
													...
													child: Padding(
														...
														child: ElevatedButton(
															onPressed: () {
																simultreeCrudBloc.add(HitungPremitreeEvent());
															},
															child: const Text(
																'Hitung',
																style: TextStyle(fontSize: 13.0),
