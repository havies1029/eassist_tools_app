...
class MRekan1CrudAPI {
	...
	Future<ReturnDataAPI> mRekan1CrudTambahAPI(MRekan1CrudModel record) async {
		String tambahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_profile/mrekan1crud/create";
	...
	Future<bool> mRekan1CrudUbahAPI(MRekan1CrudModel record) async {
		String ubahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_profile/mrekan1crud/update";
	...
	Future<bool> mRekan1CrudHapusAPI(String mrekan1Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/gen_profile/mrekan1crud/delete";
	...
	Future<MRekan1CrudModel> mRekan1CrudLihatAPI(String mrekan1Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/gen_profile/mrekan1crud/read";
