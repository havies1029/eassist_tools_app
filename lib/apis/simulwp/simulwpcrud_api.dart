...
class SimulwpCrudAPI {
  ...
  Future<bool> simulwpCrudHapusAPI(String simulwp1Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/simulwp/simulwpcrud/delete";
  ...
  Future<SimulwpCrudModel> simulwpCrudLihatAPI(String simulwp1Id) async {
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/simulwp/simulwpcrud/read";
  ...
  Future<SimulwpCrudModel> simulWpCrudInitValueAPI() async {
    String initValueEndpoint =
        "${AppData.prefixEndPoint}/api/simulwp/simulwpcrud/initvalue";
  ...
  Future<ReturnDataAPI> simulWpCrudCalcPremiAPI(SimulwpCrudModel record) async {
    String tambahEndpoint =
        "${AppData.prefixEndPoint}/api/simulwp/simulwpcrud/calcpremi";
    Map<String, String> queryParams = {"modul_id": "simulWpCrudCalcPremiAPI"};
    var uri =
        AppData.uriHtpp(AppData.httpAuthority, tambahEndpoint, queryParams);
