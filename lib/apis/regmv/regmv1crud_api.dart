...
import 'package:eassist_tools_app/models/regmv/regmv1crud_model.dart';
...
class Regmv1CrudAPI {
	...
	Future<bool> regmv1CrudHapusAPI(String regmv1Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/regmv/regmv1crud/delete";
	...
	Future<Regmv1CrudModel> regmv1CrudLihatAPI(String regmv1Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/regmv/regmv1crud/read";
