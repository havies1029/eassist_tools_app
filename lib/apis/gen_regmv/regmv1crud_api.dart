...
class Regmv1CrudAPI {
	...
	Future<ReturnDataAPI> regmv1CrudTambahAPI(Regmv1CrudModel record) async {
		String tambahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv1crud/create";
	...
	Future<bool> regmv1CrudUbahAPI(Regmv1CrudModel record) async {
		String ubahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv1crud/update";
	...
	Future<bool> regmv1CrudHapusAPI(String regmv1Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv1crud/delete";
	...
	Future<Regmv1CrudModel> regmv1CrudLihatAPI(String regmv1Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv1crud/read";
