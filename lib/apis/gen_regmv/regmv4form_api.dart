...
class Regmv4FormAPI {
	...
	Future<ReturnDataAPI> regmv4FormTambahAPI(Regmv4FormModel record) async {
		String tambahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv4form/create";
	...
	Future<bool> regmv4FormUbahAPI(Regmv4FormModel record) async {
		String ubahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv4form/update";
	...
	Future<bool> regmv4FormHapusAPI(String regmv4Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv4form/delete";
	...
	Future<Regmv4FormModel> regmv4FormLihatAPI(String regmv4Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv4form/read";
