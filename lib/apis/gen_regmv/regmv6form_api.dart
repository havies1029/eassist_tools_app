...
class Regmv6FormAPI {
	...
	Future<ReturnDataAPI> regmv6FormTambahAPI(Regmv6FormModel record) async {
		String tambahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv6form/create";
	...
	Future<bool> regmv6FormUbahAPI(Regmv6FormModel record) async {
		String ubahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv6form/update";
	...
	Future<bool> regmv6FormHapusAPI(String regmv6Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv6form/delete";
	...
	Future<Regmv6FormModel> regmv6FormLihatAPI(String regmv6Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv6form/read";
