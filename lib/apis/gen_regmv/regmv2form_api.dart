...
import 'package:eassist_tools_app/models/gen_regmv/regmv2form_model.dart';

class Regmv2FormAPI {

	Future<ReturnDataAPI> regmv2FormTambahAPI(Regmv2FormModel record) async {
		String tambahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv2form/create";
	...
	Future<bool> regmv2FormUbahAPI(Regmv2FormModel record) async {
		String ubahEndpoint =
			"${AppData.prefixEndPoint}/api/gen_regmv/regmv2form/update";
	...
	Future<bool> regmv2FormHapusAPI(String regmv2Id) async {
		String hapusEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv2form/delete";
	...
	Future<Regmv2FormModel> regmv2FormLihatAPI(String regmv2Id) async {
		String lihatEndpoint = "${AppData.prefixEndPoint}/api/gen_regmv/regmv2form/read";
