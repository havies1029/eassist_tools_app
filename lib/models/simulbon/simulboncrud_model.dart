...
class SimulbonCrudModel {
	...
	SimulbonCrudModel({required this.carNilai, required this.carPersen, 
		...
		required this.simulbon1Id, required this.uangmukaNilai, 
		required this.uangmukaPersen, this.rmatauangKode, this.comboRMatauang});
