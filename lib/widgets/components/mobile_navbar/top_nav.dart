...
class MobileTopNavigationBar extends StatefulWidget {
  const MobileTopNavigationBar({super.key});

  @override
  State<MobileTopNavigationBar> createState() => _MobileTopNavigationBarState();
}

class _MobileTopNavigationBarState extends State<MobileTopNavigationBar> {
  @override
  void initState() {
    super.initState();
