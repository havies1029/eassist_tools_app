          ...
          builder: (context, constraints) {
            ...
            return WillPopScope(
              ...
              child: GestureDetector(
                onTap: isLoggedIn ? () => Navigator.of(context).pop() : null, // ❌ Tap luar dialog diblok
                child: SingleChildScrollView(
                  child: Dialog(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                if (isLoggedIn) // ✅ Sembunyikan tombol close jika belum login
                                  GestureDetector(
                                    onTap: () => Navigator.of(context).pop(),
                                    child: Container(
                                      width: 28,
                            ...
                            child: Column(
                              ...
                              children: [
                                const CircleAvatar(
                                  ...
                                  backgroundColor: Colors.white,
                                  backgroundImage:
                                  AssetImage('assets/images/jps_logo.png'),
                                ),
                                const SizedBox(height: 24),
                                const Text(
                                  'Login Client',
