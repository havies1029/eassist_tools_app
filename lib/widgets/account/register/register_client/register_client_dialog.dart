...
class _RegisterDialogState extends State<RegisterDialog>
  ...
  Widget build(BuildContext context) {
    ...
    // Hitung lebar dialog berdasarkan device
    final dialogWidth = isMobile
        ? screenWidth * 0.9    // mobile: 98% layar
        : screenWidth < 900
        ? screenWidth * 0.8 // tablet: 80% layar
        : 500.0;             // desktop: max 600px
        ...
        return Transform.scale(
          ...
          child: Dialog(
            insetPadding: EdgeInsets.symmetric(
              horizontal: isMobile
                  ? screenWidth * 0.01 // mobile: 1% padding
                  : 40,                // desktop/tablet: default 40px
              vertical: 24,
            ),
