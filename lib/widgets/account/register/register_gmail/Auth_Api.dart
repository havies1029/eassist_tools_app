...
class AuthService {
  ...
  static Future<bool> Register(String email, {required bool rememberRegister}) async {
    try {
  ...
  static Future<bool> RegisterWithGmail() async {
    try {
      ...
      // Simulasi delay untuk demo
      await Future.delayed(const Duration(seconds: 1));
      print('Gmail Register attempt');
      return true; // Simulasi berhasil
    } catch (e) {
      print('Gmail Register error: $e');
      return false;
    }
  }

  // Register dengan Email (berbeda dengan Register biasa)
  static Future<bool> RegisterWithEmail() async {
    try {
      // TODO: Implementasi Register dengan email verification
      // Ini mungkin mengirim email verification atau metode lain

      // Simulasi delay untuk demo
      await Future.delayed(const Duration(seconds: 1));
      print('Email Register attempt');
      return true; // Simulasi berhasil
    } catch (e) {
  ...
  // Login user baru
  static Future<bool> Login(String name, String email, String type) async {
    try {
      ...
      // Simulasi delay untuk demo
      await Future.delayed(const Duration(seconds: 1));
      print('Login attempt for: $name, $email, $type');
      return true; // Simulasi berhasil
    } catch (e) {
      print('Login error: $e');
      return false;
