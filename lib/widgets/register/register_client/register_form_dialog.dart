...
class _RegisterDialogState extends State<RegisterDialog>
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // ––––– Semua field dipisahkan ke method _buildFields() –––––
            ..._buildFields(),

            const SizedBox(height: 40),

            // ––––– Tombol Daftar di method sendiri –––––
            _buildSubmitButton(),
          ],
        ),
      ),
  ...
  // ─────────────────────────────────────────────────────────────────────────
  // 1) Kumpulan field form ada di sini. Kalaupun ingin menambah bloc atau
  // validasi tambahan, tinggal edit di method ini.
  ...
  /// Tombol Daftar di method terpisah
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _isHovering
            ...
            BoxShadow(
              color:
              CustomPopupsClient.primaryGreen.withOpacity(0.3),
              blurRadius: 10,
              offset: const Offset(0, 5),
            ),
          ]
