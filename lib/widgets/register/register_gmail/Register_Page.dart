...
class CustomPopups {
  ...
  static Future<void> showDialogRegister(BuildContext context) async {
    showDialog(
      context: context,
  ...
  // Popup untuk Daftar (redirect ke Login)
                          ...
                          child: AnimatedContainer(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                borderRadius: BorderRadius.circular(10),
                                onTap: () {
                                  // Handle Gmail Register
                                  Navigator.of(context).pop();
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Register dengan Gmail!'),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.of(context).pop();
                                CustomPopups.showLoginDialog(context);
                              },
                              child: Container(
...
// Placeholder untuk LoginDialog (gunakan kode yang sudah ada)
...
class _LoginDialogState extends State<LoginDialog> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
      child: Container(
        padding: const EdgeInsets.all(20),
        child: const Text('Login Dialog - Gunakan kode yang sudah ada'),
      ),
    );
  }
}
...
class DemoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Register Dialog Demo'),
        backgroundColor: CustomPopups.primaryGreen,
