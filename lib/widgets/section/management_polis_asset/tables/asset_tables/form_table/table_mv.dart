...
class _TableMvState extends State<TableMv> {
  ...
  List<TrinaColumn> _buildColumns() {
    return [
      ...
      _textCol('No', 'no', 60),
      _textCol('Jenis Kendaraan', 'jenis', maxW * 0.15),
      _textCol('Merk', 'merk', maxW * 0.1),
      _textCol('Type', 'type', maxW * 0.13),
      _textCol('Tahun', 'tahun', maxW * 0.07),
      _textCol('No Polisi', 'nopol', maxW * 0.13),
      _textCol('Harga Pertanggungan', 'tsi', maxW * 0.15, isCurrency: true),
      _textCol('Premi', 'premi', maxW * 0.15, isCurrency: true),
