...
class _ActionSectionState extends State<ActionSection> with TickerProviderStateMixin {
  ...
  EdgeInsets get verticalPadding => EdgeInsets.symmetric(
    vertical: isMobile ? 55.0 : (isTablet ? 72.0 : 100.0),
  );
  ...
  TextStyle get subtitleTextStyle => TextStyle(
    fontFamily: 'Satoshi-Regular',
    fontSize: isMobile ? 25.0 : 30.0,
    fontWeight: FontWeight.w400,
    color: Colors.black87,
    height: 1.3,
  );

  TextStyle get benefitTextStyle => const TextStyle(
    fontSize: 16.0,
    fontFamily: 'Satoshi-Regular',
  ...
  Widget _buildBenefitPoints() {
    final layout = isMobile ? _buildMobileGrid() : _buildDesktopGrid();
    return layout;
  }
