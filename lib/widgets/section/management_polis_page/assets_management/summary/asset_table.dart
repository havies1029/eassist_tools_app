            ...
            Container(
              ...
              child: isMobile
                ...
                children: [
                  ...
                  Expanded(flex: 2, child: Text('POLIS', style: headerStyle)),
                ],
              )
                  : Row(
                children: [
                  Expanded(flex: 1, child: Text('NO', style: headerStyle)),
                  Expanded(flex: 3, child: Text('ASET', style: headerStyle)),
                  Expanded(flex: 2, child: Text('JUMLAH POLIS', style: headerStyle)),
                  Expanded(flex: 3, child: Text('TSI', style: headerStyle)),
                  Expanded(flex: 3, child: Text('TOTAL PREMI', style: headerStyle)),
                ],
              ),
            ),
            // Rows
