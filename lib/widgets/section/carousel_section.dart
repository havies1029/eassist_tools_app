...
class _CarouselSectionState extends State<CarouselSection>
  ...
  final PageController _carouselController = PageController(
    initialPage: 1000,
    viewportFraction: 0.7, // Diperkecil agar gambar samping terlihat blur
  );

  // Daftar image asset yang akan dipakai
  ...
  // Function untuk menghitung scale berdasarkan jarak ke center
  ...
  // Function untuk menghitung opacity berdasarkan jarak ke center
  ...
  Widget build(BuildContext context) {
    ...
    final titleFontSize = isMobile ? 18.0 : (isTablet ? 22.0 : 24.0);
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              // Carousel dengan efek hover, blur, dan scale
              MouseRegion(
                              ...
                              onPageChanged: (index) {
                                setState(() {
                                  _currentCarouselPage =
                                      index % _carouselImages.length;
                                });
                              },
                              // Kita gunakan jumlah _carouselImages
                              itemCount: _carouselImages.length * 1000,
                                    ...
                                    child: Container(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Stack(
                                          fit: StackFit.expand,
                                          children: [
                                            // Image.asset untuk load dari assets
                                            Image.asset(
                                              _carouselImages[realIndex],
                                              fit: BoxFit.cover,
                                              errorBuilder: (context, error,
                                                  stackTrace) {
                                                // Jika gagal load aset, tampilkan placeholder
                                                return Container(
                                            ...
                                            // Blur effect untuk gambar yang tidak active
                                            if (!isCenter)
                                              BackdropFilter(
