...
class ClientSection extends StatelessWidget {
  ...
  // Daftar seluruh asset logo klien (1 s.d. 12)
  static const List<String> _clientLogos = [
    ...
    'assets/images/client_7.png',
    'assets/images/client_8.png',
    'assets/images/client_9.png',
    'assets/images/client_10.png',
    'assets/images/client_11.png',
    'assets/images/client_12.png',
  ];
  ...
  Widget build(BuildContext context) {
    ...
    // Tentukan kolom grid: 3 kolom di mobile, 5 kolom di tablet/desktop
    final int crossAxisCount = isMobile ? 3 : 5;
    // Atur aspect ratio agar logo tetap proporsional
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: isMobile ? 30.0 : 45.0),

              // Grid 12 logo klien dari asset lokal
              GridView.builder(
                shrinkWrap: true,
                physics: const NeverScrollableScrollPhysics(),
                itemCount: _clientLogos.length,
    ...
    return MouseRegion(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          child: Padding(
            padding: EdgeInsets.all(widget.isMobile ? 6.0 : 16.0),
            child: ClipRRect(
