...
import 'package:eassist_tools_app/repositories/gen_regmv/regmv4form_repository.dart';
...
Future<void> onResetState(
  ...
  Future<void> onUploadFile(
    ...
    ReturnDataAPI returnData =
        await repository.uploadFileFotoSTNK(event.regmv4Id, event.filePath);
  ...
  Future<void> onUploadFileBytes(
    ...
    ReturnDataAPI result = await repository.uploadBinaryFotoSTNK(
        event.regmv4Id, event.fileName, event.bytes);
