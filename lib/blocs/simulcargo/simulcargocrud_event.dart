...
class ComboMMopChangedEvent extends SimulcargoCrudEvents {
  ...
  @override
  List<Object> get props => [comboMMop];
}
...
class ComboMConveyByChangedEvent extends SimulcargoCrudEvents {
  ...
  @override
  List<Object> get props => [comboMConveyBy];
}
...
class ComboMConveyDetailChangedEvent extends SimulcargoCrudEvents {
  ...
  @override
  List<Object> get props => [comboMConveyDetail];
}
...
class FieldTSIChangedEvent extends SimulcargoCrudEvents {
  final double tsi;
...
class FieldUpliftPersenChangedEvent extends SimulcargoCrudEvents {
  final double uplift;
  const FieldUpliftPersenChangedEvent({required this.uplift});

  @override
  List<Object> get props => [uplift];
}
